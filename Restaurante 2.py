...
f1 = Frame(root, width = 800, height = 70, relief=SUNKEN)
f1.pack(side=LEFT)

f2 = Frame(root, width = 300, height = 70, relief=SUNKEN)
f2.pack(side=RIGHT)
...
#Informações
lblInfo = Label(Tops, font=('arial' , 50 , 'bold') , text = "Sistema de Restaurante" , fg="steel blue" , bd=10 , anchor = "w")
...
Multiply = Button(f2, padx=16, pady=16, bd=8, fg="black" , font=("arial" , 20 , "bold") , text="*" ,
...
# Informações do Restaruante parte 2
lblDrinks = Label(f1,font=("arial" , 16, "bold"), text="Bebidas" , bd=16 , anchor="w")
lblDrinks.grid(row=0, column=2)
txtDrinks = Entry(f1, font=("arial" , 16 , "bold") , textvariable = Drinks , bd=10 , insertwidth=4,
                      bg="white" , justify="right")
txtDrinks.grid(row=0, column=3)

lblCost = Label(f1,font=("arial" , 16, "bold"), text="Custo" , bd=16 , anchor="w")
lblCost.grid(row=1, column=2)
txtCost = Entry(f1, font=("arial" , 16 , "bold") , textvariable = Cost , bd=10 , insertwidth=4,
                      bg="white" , justify="right")
txtCost.grid(row=1, column=3)

lblService = Label(f1,font=("arial" , 16, "bold"), text="Mudança de serviço" , bd=16 , anchor="w")
lblService.grid(row=2, column=2)
txtService = Entry(f1, font=("arial" , 16 , "bold") , textvariable = Service_Change , bd=10 , insertwidth=4,
                      bg="white" , justify="right")
txtService.grid(row=2, column=3)

lblStateTax = Label(f1,font=("arial" , 16, "bold"), text="Imposto estadual" , bd=16 , anchor="w")
...
lblTotalCost = Label(f1,font=("arial" , 16, "bold"), text="Custo total" , bd=16 , anchor="w")
...
btnReset=Button(f1,padx=16, pady=8, bd=16, fg="black", font=("arial" , 16, 'bold') , width=10,
                text="Zerar" , bg="powder blue" , command=Reset).grid(row=7, column=2)

btnExit=Button(f1,padx=16, pady=8, bd=16, fg="black", font=("arial" , 16, 'bold') , width=10,
                text="Sair" , bg="powder blue" , command=qExit).grid(row=7, column=3)
